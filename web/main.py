...
def dashbord():
    ...
    context = {'local_hospital_details':local_hospital_details,'local_active_cases':local_active_cases, 'local_deaths':local_deaths, 'local_recovered':local_recovered,'local_new_cases':local_new_cases,
